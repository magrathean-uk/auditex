...
Auditex is open-source software released under the Apache License, Version 2.0. See [`LICENSE`](./LICENSE) for the full licence text. Third-party components and their licences are listed in [`license.md`](./license.md) and [`THIRD_PARTY_NOTICES.md`](./THIRD_PARTY_NOTICES.md) where present. Product terms and privacy information are published at <https://auditex.hu/terms/> and <https://auditex.hu/privacy/>.
